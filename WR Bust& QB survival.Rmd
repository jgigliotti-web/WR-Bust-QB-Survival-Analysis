...
**Introduction** Applying actuarial risk-pricing principles to sports analytics allows a front office to transition from subjective scouting to objective risk management. This report details two distinct predictive projects aimed at optimizing NFL draft capital. By utilizing advanced survival techniques and generalized linear models, these projects assess physical prototypes, flag bust probabilities, and forecast career longevity for both Wide Receivers and Quarterbacks.

**Methodology & Data (What I Did)** The analysis is driven by two distinct statistical models tailored to the unique development of different positions:

-   **Project 1: Wide Receiver Profiling & Bust Probability:** I calculated player BMI and engineered a binary Power_School variable mapped to 13 programs. Because historical production data is highly right-skewed, I deployed a Gamma Generalized Linear Model to predict expected Yards_Per_Year.

    -   I isolated historical data (1967-2016), strictly defining a "Bust" as a Top-100 draft pick who recorded less than 500 career receiving yards. A binomial logistic regression was then mapped to calculate the baseline probability of failure based on draft slot and collegiate pedigree.

-   **Project 2: Quarterback Survival Analysis:** I merged college QBR metrics with NFL career lengths and active/retired status.

    -   Treating a player falling out of the league as the "failure" event, I fitted a Cox Proportional Hazards model and generated Kaplan-Meier survival curves to isolate the predictive power of College QBR while controlling for overall draft pick.

**Summary & Outcomes** These models provide actionable frameworks for navigating draft risk. The Wide Receiver Gamma GLM successfully generates a "Production Over Expectation" metric, mathematically identifying "Value Picks" who out-produce their physical measurements. Concurrently, the Quarterback Cox model definitively proves that prospects in the "High QBR (\>70)" tier possess significantly longer NFL survival rates across *all* draft rounds (1st, Day 2, and Day 3) compared to their low-QBR peers. This validates that underlying collegiate efficiency drives long-term roster stability independent of draft capital investment.
